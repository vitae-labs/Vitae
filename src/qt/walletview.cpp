...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        // Ask for passphrase if needed [this]{ gotoVerifyMessageTab(); }
        connect(_walletModel, &WalletModel::requireUnlock, [this]{ unlockWallet(); });
...
void WalletView::unlockWallet(bool stakeOnly)
{
    if(!walletModel)
        return;
    ...
    if (walletModel->getEncryptionStatus() == WalletModel::Locked)
    {
        ...
        AskPassphraseDialog dlg(stakeOnly ? AskPassphraseDialog::UnlockStaking : AskPassphraseDialog::Unlock, this);
