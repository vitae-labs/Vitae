// Copyright (c) 2011-2018 The Vitae Core developers
    ...
    void disableAppNap()
    {
        if (!activityId)
        {
            @autoreleasepool {
                ...
                {
                    activityId = [processInfo beginActivityWithOptions: activityOptions reason:@"Temporarily disable App Nap for vitae-qt."];
                    [activityId retain];
                }
            }
        }
