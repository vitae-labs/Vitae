...
//! Entry point for VitaeApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &VitaeApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for VitaeGUI tests.
void AppTests::guiTests(VitaeGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &VitaeGUI::consoleShown, this, &AppTests::consoleTests);
