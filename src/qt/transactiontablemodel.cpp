...
{
    columns << QString() << QString() << tr("Date") << tr("Type") << tr("Label") << VitaeUnits::getAmountColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
...
{
    columns[Amount] = VitaeUnits::getAmountColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
...
QString TransactionTableModel::formatTxType(const TransactionRecord *wtx) const
{
    ...
    case TransactionRecord::Minted:
        return tr("Minted");
    case TransactionRecord::FundamentalNodeReward:
        return tr("FnReward");
    case TransactionRecord::MasternodeReward:
        return tr("MasternodeReward");
    default:
        return QString();
    }
}
...
QString TransactionTableModel::formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed, VitaeUnits::SeparatorStyle separators) const
{
    QString str = VitaeUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), wtx->credit + wtx->debit, false, separators);
    if(showUnconfirmed)
    {
...
QVariant TransactionTableModel::data(const QModelIndex &index, int role) const
{
    ...
    case Qt::DisplayRole:
        ...
        case Amount:
            return formatTxAmount(rec, true, VitaeUnits::separatorAlways);
        }
        break;
    case Qt::EditRole:
    ...
    case TxPlainTextRole:
        {
            ...
            details.append(formatTxAmount(rec, false, VitaeUnits::separatorNever));
            return details;
        }
    case ConfirmedRole:
    ...
    case FormattedAmountRole:
        ...
        return formatTxAmount(rec, false, VitaeUnits::separatorNever);
    case StatusRole:
