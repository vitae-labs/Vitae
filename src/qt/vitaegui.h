...
#ifndef VITAE_QT_VITAEGUI_H
#define VITAE_QT_VITAEGUI_H
...
/**
  Vitae GUI main class. This class represents the main window of the Vitae UI. It communicates with both the client and
...
public:
    ...
    explicit VitaeGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~VitaeGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a vitae wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    //void unlockWallet(WalletModel* wallet_model);
