    ...
    mapper(nullptr)
{
    ...
    ui->vitaeAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->vitaeAtStartup);
    ...
    ui->vitaeAtStartup->setToolTip(ui->vitaeAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->vitaeAtStartup->setText(ui->vitaeAtStartup->text().arg(PACKAGE_NAME));

    ui->openVitaeConfButton->setToolTip(ui->openVitaeConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new VitaeUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->vitaeAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openVitaeConfButton_clicked()
{
