...
#ifndef VITAE_QT_GUICONSTANTS_H
#define VITAE_QT_GUICONSTANTS_H
...
/* VitaeGUI -- Size of icons in status bar */
...
#define QAPP_APP_NAME_REGTEST "Vitae-Qt-regtest"
