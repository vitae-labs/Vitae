...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatVitaeURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + VitaeUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatVitaeURI(info));
}
