...
#ifndef VITAE_TEST_SCRIPTNUM10_H
#define VITAE_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Vitae Core 0.10.0, for cross-comparison.
 */
public:
