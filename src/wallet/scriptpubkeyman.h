...
#ifndef VITAE_WALLET_SCRIPTPUBKEYMAN_H
#define VITAE_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Vitae Core wallet was originally a collection of unrelated private
...
#endif // VITAE_WALLET_SCRIPTPUBKEYMAN_H
