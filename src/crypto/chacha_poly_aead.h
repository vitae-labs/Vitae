...
#ifndef VITAE_CRYPTO_CHACHA_POLY_AEAD_H
#define VITAE_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@vitae.
 *
 ...
 *
 * The chacha20-poly1305@vitae combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@vitae cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@vitae are relatively fast in
...
#endif // VITAE_CRYPTO_CHACHA_POLY_AEAD_H
