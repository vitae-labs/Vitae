 ...
 */
#ifndef VITAE_UTIL_SYSTEM_H
#define VITAE_UTIL_SYSTEM_H
...
extern bool fShutdownRequested;
extern bool fForceStaking;
...
extern StakingStatus stakestat;

// Application startup time (used for uptime calculation)
int64_t GetStartupTime();

extern const char * const VITAE_CONF_FILENAME;
