...
#ifndef VITAE_UTIL_SETTINGS_H
#define VITAE_UTIL_SETTINGS_H
...
//!       https://github.com/vitae/vitae/pull/15934/files#r337691812)
using SettingsValue = UniValue;

//! Stored vitae settings. This struct combines settings from the command line
