...
#ifndef VITAE_VALIDATION_H
#define VITAE_VALIDATION_H
...
static const int64_t DEFAULT_MAX_TIP_AGE = 2 * 60 * 60 ;
...
/** Masternode help*/
bool AcceptableInputs(CTxMemPool& pool, TxValidationState &state, const CTransactionRef& ptx, bool ignoreFees=true);
