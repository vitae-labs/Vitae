...
#ifndef VITAE_ARITH_UINT256_H
#define VITAE_ARITH_UINT256_H
...
class base_uint
{
    //todo : WIDTH and pn made public, ensure no problems created
protected:
...
public:
     ...
     *
     * Vitae only uses this "compact" format for encoding difficulty
