...
#ifndef MASTERNODE_H
#define MASTERNODE_H
#include "util/strencodings.h"//todo
...
#include "masternodes/masternode-pos.h"
...
public:
    ...
    uint256 GetHash()
    {
        ...
        {
            n2 = UintToArith256(Hash(((char*)&(nBlockHeight)), ((char*)&((&(nBlockHeight))[1])) ));
