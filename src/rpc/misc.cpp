...
static UniValue spork(const JSONRPCRequest& request)
{
    ...
    RPCHelpMan{"spork",
        "\nReturn information about the given spork(s).\n",
        {
            {"name", RPCArg::Type::STR, /* default */ "\"\"", "The name of spork (to be set) or show to display all current spork values"},
            {"value", RPCArg::Type::NUM, /* default */ "1", "The value of spork, in epoch time"},
        },
        RPCResult{
            RPCResult::Type::OBJ, "", "",
            {
                {RPCResult::Type::BOOL, "success", "If the value is successfully set."},
    ...
    if(request.params[0].get_str() == "show"){
        std::map<int, CSporkMessage>::iterator it = mapSporksActive.begin();

        //Object ret;
                UniValue ret(UniValue::VOBJ);
        while(it != mapSporksActive.end()) {
            ret.pushKV(sporkManager.GetSporkNameByID(it->second.nSporkID), it->second.nValue);
            it++;
        }
        return ret;
    } else {
...
static UniValue validateaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"validateaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The vitae address to validate"},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
...
static UniValue verifymessage(const JSONRPCRequest& request)
{
            RPCHelpMan{"verifymessage",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The vitae address to use for the signature."},
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"echo|echojson ...",
                ...
                "vitae-cli and the GUI. There is no server-side difference.",
                {},
