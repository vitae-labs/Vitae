...
#ifndef VITAE_SCRIPT_STANDARD_H
#define VITAE_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a vitae address
 */
...
/**
 * Generate a Vitae scriptPubKey for the given CTxDestination. Returns a P2PKH
