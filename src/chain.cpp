...
const CBlockIndex* CBlockIndex::GetAncestor(int height) const
{
    ...
    //std::cout<<"pindex height = "<<pindexWalk->nHeight<<"\n";
    ...
    while (heightWalk > height) {
        ...
        if (pindexWalk->pskip != nullptr &&
            ...
            //std::cout<<"upr height = "<<heightWalk<<"\n";
        } else {
            //std::cout<<"neeche height = "<<pindexWalk->nHeight<<"\n"
...
void CBlockIndex::SetStakeModifier(uint256 nModifier, bool fGeneratedStakeModifier)
{
