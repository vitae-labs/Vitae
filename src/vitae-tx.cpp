...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " vitae-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  vitae-tx [options] <hex-tx> [commands]  Update hex-encoded vitae transaction\n" +
            "or:     vitae-tx [options] -create [commands]   Create hex-encoded vitae transaction\n" +
            "\n";
