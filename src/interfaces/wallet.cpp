...
public:
    ...
    bool unlock(const SecureString& wallet_passphrase, bool stakeOnly) override { return m_wallet->Unlock(wallet_passphrase, false, stakeOnly); }
    bool fWalletUnlockStakeOnly() {return m_wallet->fWalletUnlockStakeOnly;}
    void setfWalletUnlockStakeOnly() {m_wallet->fWalletUnlockStakeOnly = true;}
    void unsetfWalletUnlockStakeOnly() {m_wallet->fWalletUnlockStakeOnly = false;}
