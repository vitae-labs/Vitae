...
// vitae includes.
#include <..\src\script\vitaeconsensus.h>
...
int main()
{
    std::cout << "vitaeconsensus version: " << vitaeconsensus_version() << std::endl;
    ...
    auto op0Result = vitaeconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, vitaeconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
