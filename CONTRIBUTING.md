...
[good first issue](https://github.com/vitae/vitae/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or participate in a weekly [Vitae Core PR Review Club](https://vitaecore.reviews/) meeting.

Communication Channels
----------------------

Most communication about Vitae Core development happens on IRC, in the
#vitae-core-dev channel on Freenode. The easiest way to participate on IRC is
with the web client, [webchat.freenode.net](https://webchat.freenode.net/). Chat
history logs can be found
on [http://www.erisian.com.au/vitae-core-dev/](http://www.erisian.com.au/vitae-core-dev/)
and [http://gnusha.org/vitae-core-dev/](http://gnusha.org/vitae-core-dev/).

Discussion about code base improvements happens in GitHub issues and on pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/vitae-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to vitae-qt
...
[Translation Process](https://github.com/vitae/vitae/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Vitae Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Vitae
...
https://github.com/vitae/vitae/pull/16189).

Also see the [backport.py script](
https://github.com/vitae-core/vitae-maintainer-tools#backport).
