...
(define* (make-vitae-cross-toolchain target
                                  #:key
...
desirable for building Vitae Core release binaries."
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-vitae-cross-toolchain "i686-linux-gnu")
       (make-vitae-cross-toolchain "x86_64-linux-gnu")
       (make-vitae-cross-toolchain "aarch64-linux-gnu")
       (make-vitae-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-vitae-cross-toolchain "riscv64-linux-gnu"
