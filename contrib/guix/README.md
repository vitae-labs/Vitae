# Bootstrappable Vitae Core Builds

This directory contains the files necessary to perform bootstrappable Vitae
Core builds.
...
- 24GB of free disk space on the partition that the Vitae Core git repository
  resides in
...
For a Vitae Core depends development environment, simply invoke
...
From the top of a clean Vitae Core repository:
...
To use dongcarl's substitute server for Vitae Core builds after having
