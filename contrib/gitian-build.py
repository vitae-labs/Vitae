#!/usr/bin/env python3
# Copyright (c) 2018-2019 The Vitae Core developers
...
def setup():
    ...
    if not os.path.isdir('gitian.sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/vitae-core/gitian.sigs.git'])
    if not os.path.isdir('vitae-detached-sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/vitae-core/vitae-detached-sigs.git'])
    if not os.path.isdir('gitian-builder'):
        subprocess.check_call(['git', 'clone', 'https://github.com/devrandom/gitian-builder.git'])
    if not os.path.isdir('vitae'):
        subprocess.check_call(['git', 'clone', 'https://github.com/vitae/vitae.git'])
...
def verify():
    ...
    if subprocess.call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-osx-unsigned', '../vitae/contrib/gitian-descriptors/gitian-osx.yml']):
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/vitae/vitae', help='Specify the URL of the repository. Default is %(default)s')
