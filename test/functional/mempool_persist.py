...
By default, vitaed will dump mempool on shutdown and
...
class MempoolPersistTest(VitaeTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent vitaed from writing mempool.dat to disk. Verify that `savemempool` fails")
