...
class P2PPermissionsTests(VitaeTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].vitaeconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].vitaeconf, 'w', encoding="utf8") as f:
            f.write(newText)
