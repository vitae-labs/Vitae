...
class TestShell:
    """Wrapper Class for VitaeTestFramework.

    The TestShell class extends the VitaeTestFramework
    ...
    class __TestShell(VitaeTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by VitaeTestFramework child class.
            self.num_nodes = 1
