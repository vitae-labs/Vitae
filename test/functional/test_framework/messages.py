...
"""Vitae test framework primitive and message structures
...
# Objects that map to vitaed objects, which can be serialized/deserialized
...
class CTransaction:
    ...
    def deserialize(self, f):
        ...
        if len(self.vin) == 0:
            ...
            # matches the implementation in vitaed
            if (flags != 0):
                self.vin = deser_vector(f, CTxIn)
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in vitaed indicates these should be deserialized as blocks
