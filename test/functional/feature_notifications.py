...
class NotificationsTest(VitaeTestFramework):
    ...
    def run_test(self):
        ...
        if self.is_wallet_compiled():
            ...
            # https://github.com/vitae/vitae/pull/9371, it might be better
            ...
            # https://github.com/vitae/vitae/pull/16624. The bug is reported
            # in issue https://github.com/vitae/vitae/issues/18325.
