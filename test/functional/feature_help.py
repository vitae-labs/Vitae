...
"""Verify that starting vitae with -h works as expected."""

from test_framework.test_framework import VitaeTestFramework
from test_framework.util import assert_equal

class HelpTest(VitaeTestFramework):
    ...
    def run_test(self):
        self.log.info("Start vitae with -h for help text")
        ...
        self.log.info("Start vitae with -version for version information")
        ...
        self.log.info("Start vitaed with -fakearg to make sure it does not start")
