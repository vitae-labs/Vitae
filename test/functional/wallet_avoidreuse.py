...
class AvoidReuseTest(VitaeTestFramework):
    ...
    def test_fund_send_fund_senddirty(self):
        '''
        Test the same as test_fund_send_fund_send, except send the 10 VITAE with
        the avoid_reuse flag set to false. This means the 10 VITAE send should succeed,
    ...
    def test_fund_send_fund_send(self, second_addr_type):
        ...
        [0] sends 10 VITAE to A.
        [1] spends 5 VITAE from A. (leaving roughly 5 VITAE useable)
        [0] sends 10 VITAE to A again.
        [1] tries to spend 10 VITAE (fails; dirty).
        [1] tries to spend 4 VITAE (succeeds; change address sufficient)
        '''
