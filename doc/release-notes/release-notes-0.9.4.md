Vitae Core version 0.9.4 is now available from:

  https://vitae.org/bin/0.9.4/
...
this update is incompatible with the Vitae system and could lead to consensus
forks.

Vitae Core released binaries from https://vitae.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~vitae/+archive/ubuntu/vitae
- A third-party or self-compiled Vitae Core

upgrade to Vitae Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
