Vitae Core version 0.13.2 is now available from:

  <https://vitae.org/bin/vitae-core-0.13.2/>
...
- #8908 `4a974b2` Update vitae-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow vitae-tx to create v2 transactions (btcdrak)
