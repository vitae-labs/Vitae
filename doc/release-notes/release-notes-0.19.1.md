...
Vitae Core version 0.19.1 is now available from:

  <https://vitaecore.org/bin/vitae-core-0.19.1/>
...
From Vitae Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Vitae Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Vitae Core does not yet change appearance when
...
- #17488 fix "vitaed already running" warnings on macOS (fanquake)
