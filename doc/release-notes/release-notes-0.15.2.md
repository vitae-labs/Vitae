Vitae Core version *0.15.2* is now available from:

  <https://vitaecore.org/bin/vitae-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in vitae-tx (TheBlueMatt)
