Vitae-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/vitae/files/Vitae/vitae-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Vitae
...
New/changed settings (command-line or vitae.conf file)
--------------------------------------------------------
