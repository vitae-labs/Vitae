Vitae Core version 0.10.4 is now available from:

  <https://vitae.org/bin/vitae-core-0.10.4/>
...
- #6953 `43c2789` Split vitae-tx into its own package
- #6953 `dfe0d4d` Include vitae-tx binary on Debian/Ubuntu
