Vitae Core version 0.9.2.1 is now available from:

  https://vitae.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 VITAE to 0.01 VITAE
...
- Fix "Start vitae on system login"
