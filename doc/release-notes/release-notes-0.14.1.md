Vitae Core version 0.14.1 is now available from:

  <https://vitae.org/bin/vitae-core-0.14.1/>
...
here:
[reducing-vitaed-memory-usage.md](https://gist.github.com/laanwj/efe29c7661ce9b6620a7).
...
- #10130 `ecc5232` vitae-tx input verification (awemany, jnewbery)
