Vitae version 0.5.4 is now available for download at:
http://sourceforge.net/projects/vitae/files/Vitae/vitae-0.5.4/
...
http://gitorious.org/vitae/vitaed-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Vitae-Qt notifications under Growl 1.3.
Increase required age of Vitae-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxVitae properly when installing Vitae-Qt over it. (Windows)
