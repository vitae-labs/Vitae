Vitae Core version 0.14.2 is now available from:

  <https://vitae.org/bin/vitae-core-0.14.2/>
...
(in Vitae Core 0.10.3) it has been disabled by default.
...
- #10228 `ae479bc` Regenerate vitae-config.h as necessary (theuni)
