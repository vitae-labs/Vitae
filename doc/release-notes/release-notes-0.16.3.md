Vitae Core version 0.16.3 is now available from:

  <https://vitaecore.org/bin/vitae-core-0.16.3/>
...
been discovered in Vitae Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` vitaeconsensus: invalid flags error should be set to `vitaeconsensus_err` (afk11)
