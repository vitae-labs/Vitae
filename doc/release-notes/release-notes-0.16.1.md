Vitae Core version 0.16.1 is now available from:

  <https://vitaecore.org/bin/vitae-core-0.16.1/>
...
- #12843 `df38b13` Test starting vitaed with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure vitaed processes are cleaned up when tests end (sdaftuar)
