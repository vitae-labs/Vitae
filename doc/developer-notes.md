...
Run with the `-testnet` option to run with "play vitaes" on the test network, if you
...
([`valgrind.supp`](https://github.com/vitae/vitae/blob/master/contrib/valgrind.supp))
...
To profile a running vitaed process for 60 seconds, you could use an
invocation of `perf record` like this:

```sh
$ perf record \
    -g --call-graph dwarf --per-thread -F 140 \
    -p `pgrep vitaed` -- sleep 60
```
...
Vitae Core can be compiled with various "sanitizers" enabled, which add
 ...
 * [Issue #12691: Enable -fsanitize flags in Travis](https://github.com/vitae/vitae/issues/12691)
...
- Use include guards to avoid the problem of double inclusion. The header file
  `foo/bar.h` should use the include guard identifier `VITAE_FOO_BAR_H`, e.g.

```c++
#ifndef VITAE_FOO_BAR_H
#define VITAE_FOO_BAR_H
...
#endif // VITAE_FOO_BAR_H
```
...
Some of these are maintained by active developers of Vitae Core, in which case changes should probably go
...
- src/secp256k1
  - Upstream at https://github.com/vitae-core/secp256k1/ ; actively maintained by Core contributors.

- src/crypto/ctaes
  - Upstream at https://github.com/vitae-core/ctaes ; actively maintained by Core contributors.

- src/univalue
  - Upstream at https://github.com/vitae-core/univalue ; actively maintained by Core contributors, deviates from upstream https://github.com/jgarzik/univalue
...
compatibility between nodes. This happened in Vitae 0.8 (when LevelDB was
...
would be to revert the upstream fix before applying the updates to Vitae's
...
- [scripted-diff: Rename InitInterfaces to NodeContext](https://github.com/vitae/vitae/commit/301bd41a2e6765b185bd55f4c541f9e27aeea29d)
uses an elegant script to replace occurrences of multiple terms in all source files.

- [scripted-diff: Remove g_connman, g_banman globals](https://github.com/vitae/vitae/commit/8922d7f6b751a3e6b3b9f6fb7961c442877fb65a)
replaces specific terms in a list of specific source files.

- [scripted-diff: Replace fprintf with tfm::format](https://github.com/vitae/vitae/commit/fac03ec43a15ad547161e37e53ea82482cc508f9)
...
- Wallet RPCs call BlockUntilSyncedToCurrentChain to maintain consistency with
  ...
  - *Rationale*: In previous versions of Vitae Core, the wallet was always
...
- For consistency and friendliness to code generation tools, interface method
  ...
  before in [#14635](https://github.com/vitae/vitae/pull/14635).
